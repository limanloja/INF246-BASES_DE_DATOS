...
VALUES(SP_ORDEN_PRODUCCION_SEQ.Nextval, 'P', TO_TIMESTAMP('2022-07-04', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), 'A');
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 1, 1, 15);
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval,1, 2, 85);

INSERT INTO SP_ORDEN_PRODUCCION (ID_ORDEN, MOTIVO, FECHA_REGISTRO, FECHA_AUTORIZACION, FECHA_FIN, ESTADO)
VALUES(SP_ORDEN_PRODUCCION_SEQ.Nextval, 'E', TO_TIMESTAMP('2022-07-18', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), 'A');
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 2, 3, 45);
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 2, 4, 105);
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 2, 5, 80);


INSERT INTO SP_ORDEN_PRODUCCION (ID_ORDEN, MOTIVO, FECHA_REGISTRO, FECHA_AUTORIZACION, FECHA_FIN, ESTADO)
VALUES(SP_ORDEN_PRODUCCION_SEQ.Nextval, 'P', TO_TIMESTAMP('2022-08-04', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), 'A');
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 3, 1, 10);
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 3, 2, 80);
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 3, 3, 40);


INSERT INTO SP_ORDEN_PRODUCCION (ID_ORDEN, MOTIVO, FECHA_REGISTRO, FECHA_AUTORIZACION, FECHA_FIN, ESTADO)
VALUES(SP_ORDEN_PRODUCCION_SEQ.Nextval, 'E', TO_TIMESTAMP('2022-08-18', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-09-09', 'YYYY-MM-DD'), 'A');
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 4, 4, 100);
INSERT INTO SP_DETALLE_PRODUCTO (ID_COMPRA, ID_ORDEN, ID_PRODUCTO, UNIDADES) VALUES(SP_DETALLE_PRODUCTO_SEQ.Nextval, 4, 5, 75);
