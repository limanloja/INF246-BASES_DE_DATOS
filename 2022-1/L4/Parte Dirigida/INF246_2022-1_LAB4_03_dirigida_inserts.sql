...
INSERT INTO UNIVERSIDADES VALUES('0003', 'Nacional San Agustin', 'Arequipa', 'Santa Catalina', '11000');
...
Insert into EMPLEADOS (DNI,NOMBRE,APELLIDO1,APELLIDO2,DIRECC1,CIUDAD,MUNICIPIO,COD_POSTAL,SEXO,FECHA_NAC,DIRECC2) values ('42269875','Maria','Rosal','Cruz','Primavera 1258','Lima','Surco','11700','M',to_date('15/07/1970','DD/MM/YYYY'),'Urb. Los Rosales');
Insert into EMPLEADOS (DNI,NOMBRE,APELLIDO1,APELLIDO2,DIRECC1,CIUDAD,MUNICIPIO,COD_POSTAL,SEXO,FECHA_NAC,DIRECC2) values ('10684781','Pilar','Perez','Rollen','Av. Canada 1203','Lima','La Victoria','11600','M',to_date('02/08/1978','DD/MM/YYYY'),'Urb. Balconcillo');
Insert into EMPLEADOS (DNI,NOMBRE,APELLIDO1,APELLIDO2,DIRECC1,CIUDAD,MUNICIPIO,COD_POSTAL,SEXO,FECHA_NAC,DIRECC2) values ('38744043', 'Luis Felipe', 'Casas', 'Frias', 'Los Alamos 345', 'Lima', 'Chorrillos', '12800', 'H', to_date('02/08/1981','DD/MM/YYYY'),'Urb. Matellini');
Insert into EMPLEADOS (DNI,NOMBRE,APELLIDO1,APELLIDO2,DIRECC1,CIUDAD,MUNICIPIO,COD_POSTAL,SEXO,FECHA_NAC,DIRECC2) values ('07845147', 'Beatriz Rosario', 'Segura', 'Chipoco', 'Tnte. Ugaz 340', 'Callao', 'Bellavista', '11000', 'M',to_date('25/11/1966','DD/MM/YYYY'),'Urb. El Pacifico');
Insert into EMPLEADOS (DNI,NOMBRE,APELLIDO1,APELLIDO2,DIRECC1,CIUDAD,MUNICIPIO,COD_POSTAL,SEXO,FECHA_NAC,DIRECC2) values ('06847120', 'Mercedes', 'Palomino', 'Cuya', 'Jr. Mellet 257', 'Lima', 'Chorrillos', '12800', 'H', to_date('12/03/1977','DD/MM/YYYY'),'Urb. Matellini');
Insert into EMPLEADOS (DNI,NOMBRE,APELLIDO1,APELLIDO2,DIRECC1,CIUDAD,MUNICIPIO,COD_POSTAL,SEXO,FECHA_NAC,DIRECC2) values ('16789674', 'Harry', 'Soto', 'Aguilar', 'Av. Mexico 119', 'Lima', 'La Victoria', '11600', 'H', to_date('02/08/1971','DD/MM/YYYY'),'Urb. Balconcillo'); 
