...
Insert into pp_cliente (Id_cliente, apellido_paterno, apellido_materno, nombres, tipo_documento, numero_documento, fecha_nacimiento, direccion, referencia, ubigeo, telefono_contacto, correo_electronico, fecha_creacion, estado) VALUES (3,'Zu�iga','Cuya','Sergio Miguel','R','19875128601',to_date('12/09/1982','dd/mm/yyyy'),'Av. Brasil 1678','Al costado de la iglesia de los Mormones','150711','953781458','szcuya@yucy.com',to_date('09/07/2012','dd/mm/yyyy'),'B');
...
insert into pp_tarjeta_bancaria (id_tarjeta, numero_tarjeta, id_cuenta, ubicacion, fecha_emision, fecha_vencimiento, estado,compras_internet) values(2,'4042786215468318',8,'V',to_date('03/05/2016', 'dd/mm/yyyy'), to_date('15/11/2021', 'dd/mm/yyyy'), 'V', 'A');
...
insert into pp_tarjeta_bancaria (id_tarjeta, numero_tarjeta, id_cuenta, ubicacion, fecha_emision, fecha_vencimiento, estado,compras_internet) values(7,'4387184165731970',10,'V',to_date('15/08/2017', 'dd/mm/yyyy'), to_date('12/12/2021', 'dd/mm/yyyy'), 'V', 'A');
insert into pp_tarjeta_bancaria (id_tarjeta, numero_tarjeta, id_cuenta, ubicacion, fecha_emision, fecha_vencimiento, estado,compras_internet) values(8,'4187511208719641',2,'V',to_date('25/06/2017', 'dd/mm/yyyy'), to_date('01/07/2024', 'dd/mm/yyyy'), 'V', 'A');
...
insert into pp_tarjeta_bancaria (id_tarjeta, numero_tarjeta, id_cuenta, ubicacion, fecha_emision, fecha_vencimiento, estado,compras_internet) values(11,'3812348176808923',9,'A',to_date('01/07/2010', 'dd/mm/yyyy'), to_date('11/10/2021', 'dd/mm/yyyy'), 'A', 'A');
insert into pp_tarjeta_bancaria (id_tarjeta, numero_tarjeta, id_cuenta, ubicacion, fecha_emision, fecha_vencimiento, estado,compras_internet) values(12,'3534265845259864',12,'F',to_date('01/09/2017', 'dd/mm/yyyy'), to_date('05/01/2022', 'dd/mm/yyyy'), 'V', 'A');
insert into pp_tarjeta_bancaria (id_tarjeta, numero_tarjeta, id_cuenta, ubicacion, fecha_emision, fecha_vencimiento, estado,compras_internet) values(13,'3945579643525352',4,'V',to_date('01/10/2021', 'dd/mm/yyyy'), to_date('01/10/2028', 'dd/mm/yyyy'), 'P', 'I');
...
insert into pp_transferencia (id_transferencia, cuenta_origen, cuenta_destino, monto_transferido, mensaje, fecha_transaccion, fecha_confirmacion, estado) values(7,1,6,490,'para reparaciones',to_date('13/07/2021','dd/mm/yyyy'), to_date('13/07/2021', 'dd/mm/yyyy'), 'A');
...
insert into pp_transferencia (id_transferencia, cuenta_origen, cuenta_destino, monto_transferido, mensaje, fecha_transaccion, fecha_confirmacion, estado) values(9,6,8,1150,'por servicios',to_date('21/08/2021','dd/mm/yyyy'), to_date('27/08/2021', 'dd/mm/yyyy'), 'A');
insert into pp_transferencia (id_transferencia, cuenta_origen, cuenta_destino, monto_transferido, mensaje, fecha_transaccion, fecha_confirmacion, estado) values(10,6,8,2000,'por contratos',to_date('21/08/2021','dd/mm/yyyy'), to_date('29/08/2021', 'dd/mm/yyyy'), 'A');
