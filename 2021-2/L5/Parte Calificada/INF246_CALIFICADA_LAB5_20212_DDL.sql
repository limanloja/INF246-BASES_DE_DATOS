BEGIN
	EXECUTE IMMEDIATE 'DROP TABLE pp_transferencia cascade constraints';
	EXECUTE IMMEDIATE 'DROP TABLE pp_tarjeta_bancaria cascade constraints';
	EXECUTE IMMEDIATE 'DROP TABLE pp_cuenta_bancaria cascade constraints';
	EXECUTE IMMEDIATE 'DROP TABLE pp_clasificacion_cuenta cascade constraints';
	EXECUTE IMMEDIATE 'DROP TABLE pp_cliente cascade constraints';
	EXECUTE IMMEDIATE 'DROP TABLE pp_distrito cascade constraints';
	EXECUTE IMMEDIATE 'DROP TABLE pp_provincia cascade constraints';
	EXECUTE IMMEDIATE 'DROP TABLE pp_region cascade constraints';
...
CREATE TABLE pp_tarjeta_bancaria (
    ...
    estado            CHAR(1 BYTE) NOT NULL,
	compras_internet  CHAR(1 BYTE) NOT NULL
);
...
COMMENT ON COLUMN pp_tarjeta_bancaria.compras_internet IS
    'Indica si tiene activa la opción de compras en internet. ''A'' activo ''I'' inactivo.';
